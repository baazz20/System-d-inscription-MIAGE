...
<html lang="fr">
    ...
    <head>
        ...
        <title>
            MIAGE-GI | <?php echo $_SESSION['user_name']; ?>
        </title>
        <!--     Fonts and icons     -->
                    ...
                    <div class="collapse navbar-collapse me-md-0 me-sm-4 mt-sm-0 mt-2" id="navbar">
                        ...
                        <ul class="navbar-nav justify-content-end">
                            <li class="nav-item d-flex align-items-center">
                                ...
                                <div class=" dropdown nav-link text-white font-weight-bold px-0">

                                    <span class="d-sm-inline d-none dropdown-toggle" id="dropdownMenuButton"
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <li>
                                            ...
                                            <a class="dropdown-item" href="config/deconnexion.php">
                                ...
                                <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link mb-0 px-0 py-1 active " data-bs-toggle="tab"
                                            href="javascript:;" role="tab" aria-controls="overview"
                                            aria-selected="true">
                                            <svg class="text-dark" width="16px" height="16px" viewBox="0 0 42 42"
                                                ...
                                                <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none"
                                                    fill-rule="evenodd">
                                                    <g id="Rounded-Icons"
                                                        transform="translate(-2319.000000, -291.000000)" fill="#FFFFFF"
                                                        fill-rule="nonzero">
                                                        <g id="Icons-with-opacity"
                                                            transform="translate(1716.000000, 291.000000)">
                                                            <g id="box-3d-50"
