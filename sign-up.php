            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navigation">
                    ...
                    <ul class="navbar-nav d-lg-block d-none">
                        <li class="nav-item">
                            <a href="https://www.univ-fhb.edu.ci/index.php/ufr-mi/"target="_blank" rel="noopener noreferrer"
                                class="btn btn-sm btn-round mb-0 me-1 bg-gradient-light">UFR MI</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-5 text-center mx-auto">
                            ...
                            <p class="text-lead text-white">Utilisez ce formulaire impressionnant pour vous créer un nouveau compte dans
                                 gratuitement.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mt-lg-n10 mt-md-n11 mt-n10">
                    <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                        <div class="card z-index-0">
                            ...
                            <div class="card-body">
                                <form role="form text-left" action="controller/admin_register.php" method="POST" enctype="multipart/form-data">
                                    <div class="mb-0">
                                    <span class="border-0 d-flex align-items-center px-0 mb-2">
                                        ...
                                        <div class="d-flex align-items-start flex-column justify-content-center">
                                            ...
                                            <label for="file-ip-1" class="btn btn-link pe-3 ps-0 ms-auto">Sélèctionner une photo de profil</label>
                                                <input style="display:none;" type="file" class="form-control" name="photoAdmin" id="file-ip-1" accept="image/*" onchange="showPreview(event);">
                                        </h6>
                                        </div>
                                    </span>
                                    </div>
                                    <div class="mb-3">
                                        <input type="text" class="form-control" placeholder="Nom d'utilisateur" aria-label="Nom"
                                            aria-describedby="email-addon" name="uname">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="form-check form-check-info text-left">
                                        ...
                                        je suis d'accord les <a href="javascript:;"
                                                class="text-dark font-weight-bolder">Termes et conditions</a>
                                        </label>
                                    </div>
                                    <div class="text-center">
                                        <button type="submit" class="btn bg-gradient-dark w-100 my-4 mb-2" name="nouvelAdmin">S'inscrire</button>
                                    </div>
                                    <p class="text-sm mt-3 mb-0">Vous avez déjà un compte? <a href="connexion.php"
                                            class="text-dark font-weight-bolder">S'identifier</a></p>
                                </form>
                            </div>
                        </div>
                    </div>
