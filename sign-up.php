        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navigation">
                ...
                <ul class="navbar-nav d-lg-block d-none">
                    <li class="nav-item">
                        <a href="https://www.univ-fhb.edu.ci/index.php/ufr-mi/" target="_blank" rel="noopener noreferrer" class="btn btn-sm btn-round mb-0 me-1 bg-gradient-light">UFR MI</a>
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                            <form role="form text-left" action="controller/admin_register.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <input type="text" class="form-control" placeholder="Nom d'utilisateur" aria-label="Nom" aria-describedby="email-addon" name="uname">
                                </div>
                                <div class="mb-3">
                                ...
                                <p class="text-sm mt-3 mb-0">Vous avez déjà un compte? <a href="connexion.php" class="text-dark font-weight-bolder">S'identifier</a></p>
                            </form>
                        </div>
                    </div>
                </div>
