            ...
            <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
                ...
                <div class="card-body text-left p-3 w-100">
                    ...
                    <!-- <div class="docs-info">
                            ...
                            <p class="text-xs font-weight-bold">Veuillez consulter nos documents</p>
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Comptes</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">Comptes</h6>
                </nav>
                            ...
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $ret = mysqli_query($conn, "select * from client");
                                        $cnt = 1;
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex px-2 py-1">
                                                            <div>
                                                                <img src="assets/uploads/photoIdentite/<?php echo $row['lienphoto']; ?>" class="avatar avatar-sm me-3">
                                                            </div>
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <h6 class="mb-0 text-sm"><?php echo $row['nomclient']; ?>
                                                                    <?php echo $row['prenomclient']; ?></h6>
                                                                <p class="text-xs text-secondary mb-0">
                                                                    <?php echo $row['email']; ?>
                                                                </p>
                                                            </div>
                                                    ...
                                                    <td>
                                                        ...
                                                        <p class="text-xs text-secondary mb-0"><?php echo $row['telephone']; ?>
                                                        </p>
                                                    </td>
                                                    <td class="align-middle text-center text-sm">
                                                        <span class="badge badge-sm bg-gradient-success"><?php echo $row['cni_passport']; ?></span>
                                                    </td>
                                                    <td class="align-middle text-center">
                                                        <span class="text-secondary text-xs font-weight-bold"><?php echo $row['datenaiss']; ?></span>
                                                    </td>
                                                    <td class="align-middle">
                                                        <a href="billing.php?viewid=<?php echo htmlentities($row['idclient']); ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                                            <i class="fas fa-eye"></i>&emsp;
                                                        </a>
                                                        <span href="edit.php?editid=<?php echo htmlentities($row['idclient']); ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                                            <i class="fas fa-user-edit" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal"></i>&emsp;
                                                        </span>
                                                        <a href="tables.php?delid=<?php echo ($row['idclient']); ?>&&ppic=<?php echo $row['lienphoto']; ?>" onclick="return confirm('Voulez vous vraiment le suprimer ?');" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form role="form text-left" action="controller/etudiantContoller.php" method="POST" enctype="multipart/form-data">
                                ...
                                <section>
                                    <p><svg class="text-dark" width="16px" height="16px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
